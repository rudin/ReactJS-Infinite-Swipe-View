...
/***/ function(module, exports, __webpack_require__) {
	...
	var _indexCss = __webpack_require__(1);
	...
	if (typeof document !== 'undefined') {
	  _react2['default'].render(_react2['default'].createElement(_componentsApp2['default'], { className: _indexCss2['default'].main }), document.getElementById('root'));
	}
...
/***/ function(module, exports) {
	...
	module.exports = {"main":"index__main___2nGBg"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppCss = __webpack_require__(159);
	...
	var _TouchAreaTouchArea = __webpack_require__(180);

	var _TouchAreaTouchArea2 = _interopRequireDefault(_TouchAreaTouchArea);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'setElementWidth',
	    value: function setElementWidth() {
	    ...
	    value: function handleTouchStart() {
	      var memorizePosition = this.state.position;
	      this.touchStartedAt = Date.now();
	      this.setState({ memorizePosition: memorizePosition, touching: true });
	    }
	  }, {
	    key: 'handleTouchMove',
	    value: function handleTouchMove(offset) {
	      // percentage van de breedte van window van makon!!!
	      var _state = this.state;
	      var width = _state.width;
	      var memorizePosition = _state.memorizePosition;
	      var items = _state.items;

	      var numItems = items.length - 1;
	      var offsetAsFactorOfOne = -1 / width * offset;
	      var newPosition = memorizePosition + offsetAsFactorOfOne;
	      // klopt NOG NIET.. ER IS EEN DEEL VAN DE OFFSET DIE voor 1/2 gerekend moet worden!!!
	      // 's avonds maar 's verder mee klooien ;-)
	      // voor nu belangrijkst: de SPRING er in...
	      if (newPosition < 0 || memorizePosition < 0) {
	        // nee zo snel gaat dat niet... welk deel van de offset moet ik halveren?!
	        var tooFar = newPosition;
	      ...
	      if (newPosition > numItems || memorizePosition > numItems) {
	        var tooFar = newPosition - numItems;
	    ...
	    value: function handleTouchEnd() {
	      ...
	      var memorizePosition = _state2.memorizePosition;
	      var items = _state2.items;

	      var flickTime = Date.now() - this.touchStartedAt;
	      var newPosition = Math.round(position);
	      if (flickTime < 300) {
	    ...
	    value: function GetPanes() {
	      ...
	      var firstItemToRender = Math.floor(position);

	      var itemsToRender = items.filter(function (item, i) {
	        return i == firstItemToRender || i == firstItemToRender + 1;
	      });
	      ...
	      return itemsToRender.map(function (item, i) {
	        // what happens when dragging to minus-something
	        var text = 'item: ' + item + ', position: ' + Math.round(position * 10) / 10 + ', firstItemToRender: ' + firstItemToRender + ', i: ' + i;

	        // position bepaald first item to render
	        return _react2['default'].createElement(
	          'div',
	          { className: _AppCss2['default'].pane, key: i + firstItemToRender, style: { WebkitTransform: 'translateX(' + -100 * (position - firstItemToRender - i) + '%)' } },
	          text
	        );
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      var position = _state4.position;
	      var touching = _state4.touching;
	      ...
	      */
	      ...
	      return _react2['default'].createElement(
	        ...
	        function (interpolated) {
	          ...
	          var position = interpolated.y.val;
	          ...
	          var RenderedItems = itemsToRender.map(function (item, i) {
	            // what happens when dragging to minus-something
	            var text = 'item: ' + item + ', position: ' + Math.round(position * 10) / 10 + ', firstItemToRender: ' + firstItemToRender + ', i: ' + i;
	          ...
	          return _react2['default'].createElement(
	            ...
	            RenderedItems,
	            _react2['default'].createElement(_TouchAreaTouchArea2['default'], { handleTouchStart: _this.handleTouchStart, handleTouchMove: _this.handleTouchMove, handleTouchEnd: _this.handleTouchEnd })
	          );
	        }
	      );
	    }

	    // deze 'panes' worden op de juiste plek gezet met translate en spring-value
	  }]);
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"pane":"App__pane___22iwm"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Spring = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapTree = __webpack_require__(164);

	var _mapTree2 = _interopRequireDefault(_mapTree);

	var _noVelocity = __webpack_require__(170);

	var _noVelocity2 = _interopRequireDefault(_noVelocity);

	var _compareTrees = __webpack_require__(171);
	...
	var _animationLoop = __webpack_require__(173);

	var _animationLoop2 = _interopRequireDefault(_animationLoop);

	var _zero = __webpack_require__(176);

	var _zero2 = _interopRequireDefault(_zero);

	var _updateTree = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepper = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TouchAreaCss = __webpack_require__(181);

	var _TouchAreaCss2 = _interopRequireDefault(_TouchAreaCss);

	var _react = __webpack_require__(2);

	var _react2 = _interopRequireDefault(_react);

	var TouchArea = (function (_Component) {
	  _inherits(TouchArea, _Component);

	  function TouchArea(props) {
	    _classCallCheck(this, TouchArea);

	    _get(Object.getPrototypeOf(TouchArea.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      startPosition: 0,
	      currentPosition: 0,
	      offset: 0,
	  ...
	  _createClass(TouchArea, [{
	    key: 'handleTouchStart',
	    value: function handleTouchStart(event) {
	      // event.preventDefault();
	      var startPosition = this.calculatePointerPosition(event);
	      this.setState({ startPosition: startPosition, touching: true });
	    ...
	    value: function handleTouchMove(event) {
	      ...
	      var el = _react2['default'].findDOMNode(this);
	      var currentPosition = this.calculatePointerPosition(event);
	      var offset = currentPosition - this.state.startPosition;
	      this.setState({
	    ...
	    value: function calculatePointerPosition(event) {
	      ...
	      var pos = event.clientX - rect.left;
	      return pos;
	    }
	  }, {
	    key: 'componentDidMount',
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('div', { className: _TouchAreaCss2['default'].area });
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"area":"TouchArea__area___3KuZD"};
